...
<body>
        <nav class="navbar navbar-expand-lg navbar-light bg-light" >
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                ...
                <ul class="navbar-nav ml-auto"> <!-- Sử dụng lớp ml-auto để đẩy nội dung sang phải -->
                    <li class="nav-item">
                        <div class="nav-link">Name: {{session('profile')[0]['first_name'] . ' '.session('profile')[0]['last_name'] }}</div>
                    </li>
                    <li class="nav-item">
